 ...
 * ---------
 *
 * [DONE] 1) Implementar message.cpp de acordo com a especificação de message.h.
 * [DONE] 2) Imprimir as mensagens por ordem de
 *    a) Remetente
 *    b) Assunto
 *    c) Data de envio
 *    utilizando functors.
 *
 * [DONE] 3) Fazer o programa trabalhar com objetos mensagem criado com alocação
 * dinâmica e ponteiros.
 *
 * [DONE] 4) Converter o programa do passo 2 para trabalhar com std::unique_ptr<>.
 *
 */
#include <iostream>
#include <algorithm>
...
int main( )
{
    ...
    sortMessage mySorterSubject( Message::HeaderField::SUBJECT );
    sortMessage mySorterDate( Message::HeaderField::DATE );
    sortMessage mySorterSender( Message::HeaderField::SENDER );
